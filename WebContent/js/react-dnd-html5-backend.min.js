!function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.ReactDnDHTML5Backend = e() : t.ReactDnDHTML5Backend = e()
}(this, function() {
    return function(t) {
        function e(n) {
            if (r[n])
    ...
    , function(t, e, r) {
        function n(t, e) {
            ...
            function() {
                for (var r = arguments, n = -1, i = u(r.length - e, 0), a = Array(i); ++n < i; )
                    a[n] = r[e + n];
                switch (e) {
                case 0:
    ...
    , function(t, e, r) {
        (function(t, n) {
            var o = r(54)
              ...
              , s = o(a && u && "object" == typeof n && n)
              , c = o(i[typeof self] && self)
              , f = o(i[typeof window] && window)
              , p = o(i[typeof this] && this)
              , d = s || f !== (p && p.window) && f || c || p || Function("return this")();
            t.exports = d
        }
        ).call(e, r(85)(t), function() {
            return this
        }())
    }
    , function(t, e) {
    ...
    , function(t, e, r) {
        function n(t, e) {
            ...
            if (o(e)) {
                var n = r.__data__
                  , a = "string" == typeof e ? n.string : n.hash;
                return a[e] === i
            }
            return r.has(e)
        }
    ...
    , function(t, e, r) {
        function n(t) {
            return o(t) && u.call(t, "callee") && (!c.call(t, "callee") || s.call(t) == i)
        }
        var o = r(11)
          , i = "[object Arguments]"
          , a = Object.prototype
    ...
    , function(t, e, r) {
        function n(t) {
            return null != t && !("function" == typeof t && i(t)) && a(o(t))
        }
        var o = r(58)
          , i = r(12)
          , a = r(26);
        ...
        var i = r(83)
          ...
          , c = function() {
            ...
            return t.prototype.enter = function(t) {
                ...
                0 === e && this.entered.length > 0
            }
            ,
            t.prototype.leave = function(t) {
                var e = this.entered.length;
                return this.entered = s["default"](this.entered.filter(function(t) {
        ...
        var a = r(75)
          ...
          , y = function() {
            function t(e) {
                ...
                this.enterLeaveCounter = new p["default"],
            ...
            t.prototype.teardown = function() {
                "undefined" != typeof window && (this.constructor.isSetUp = !1,
            ...
            t.prototype.connectDragPreview = function(t, e, r) {
                var n = this;
                return this.sourcePreviewNodeOptions[t] = r,
                this.sourcePreviewNodes[t] = e,
                function() {
                    delete n.sourcePreviewNodes[t],
                    delete n.sourcePreviewNodeOptions[t]
                }
            }
            ,
            t.prototype.connectDragSource = function(t, e, r) {
                var n = this;
                this.sourceNodes[t] = e,
                this.sourceNodeOptions[t] = r;
                var o = function(e) {
                ...
                function() {
                    delete n.sourceNodes[t],
                    delete n.sourceNodeOptions[t],
                    e.removeEventListener("dragstart", o),
                    e.removeEventListener("selectstart", i),
            ...
            t.prototype.connectDropTarget = function(t, e) {
                ...
                ;
                return e.addEventListener("dragenter", n),
                e.addEventListener("dragover", o),
                e.addEventListener("drop", i),
                function() {
                    e.removeEventListener("dragenter", n),
                    e.removeEventListener("dragover", o),
            ...
            t.prototype.getCurrentSourcePreviewNodeOptions = function() {
                var t = this.monitor.getSourceId()
                  , e = this.sourcePreviewNodeOptions[t];
                return u["default"](e || {}, {
                    anchorX: .5,
                    anchorY: .5,
            ...
            t.prototype.getSourceClientOffset = function(t) {
                return h.getNodeClientOffset(this.sourceNodes[t])
            }
            ,
            t.prototype.isDraggingNativeItem = function() {
                var t = this.monitor.getItemType();
                return Object.keys(g).some(function(e) {
                    return g[e] === t
                })
            }
            ,
            t.prototype.beginDragNativeItem = function(t) {
                this.clearCurrentDragSourceNode();
                var e = l.createNativeDragSource(t);
                this.currentNativeSource = new e,
                this.currentNativeHandle = this.registry.addSource(t, this.currentNativeSource),
                this.actions.beginDrag([this.currentNativeHandle]),
                d.isFirefox() && window.addEventListener("mousemove", this.endDragNativeItem, !0)
            }
            ,
            t.prototype.endDragNativeItem = function() {
                this.isDraggingNativeItem() && (d.isFirefox() && window.removeEventListener("mousemove", this.endDragNativeItem, !0),
            ...
            t.prototype.endDragIfSourceWasRemovedFromDOM = function() {
                ...
                document.body.contains(t) || this.clearCurrentDragSourceNode() && this.actions.endDrag()
            }
            ,
            t.prototype.setCurrentDragSourceNode = function(t) {
                this.clearCurrentDragSourceNode(),
                this.currentDragSourceNode = t,
                this.currentDragSourceNodeOffset = h.getNodeClientOffset(t),
            ...
            t.prototype.clearCurrentDragSourceNode = function() {
                ...
                this.currentDragSourceNodeOffsetChanged = !1,
                window.removeEventListener("mousemove", this.endDragIfSourceWasRemovedFromDOM, !0),
                !0) : !1
            }
            ,
            t.prototype.checkIfCurrentDragSourceRectChanged = function() {
                var t = this.currentDragSourceNode;
                return t ? this.currentDragSourceNodeOffsetChanged ? !0 : (this.currentDragSourceNodeOffsetChanged = !c["default"](h.getNodeClientOffset(t), this.currentDragSourceNodeOffset),
                this.currentDragSourceNodeOffsetChanged) : !1
            }
            ,
            ...
            t.prototype.handleTopDragStart = function(t) {
                var e = this
                  , r = this.dragStartSourceIds;
                this.dragStartSourceIds = null ;
                var n = h.getEventClientOffset(t);
                ...
                if (this.monitor.isDragging()) {
                    if ("function" == typeof o.setDragImage) {
                        var a = this.monitor.getSourceId()
                          ...
                          , v = h.getDragPreviewOffset(u, s, n, d);
                        o.setDragImage(s, v.x, v.y)
                    }
                    try {
                    ...
                    var y = this.getCurrentSourcePreviewNodeOptions()
                      , D = y.captureDraggingState;
                    D ? this.actions.publishDragSource() : setTimeout(function() {
                        return e.actions.publishDragSource()
                    })
                } else if (i)
                    this.beginDragNativeItem(i);
                else {
                    if (!(o.types || t.target.hasAttribute && t.target.hasAttribute("draggable")))
                        return;
                    t.preventDefault()
                }
            }
            ...
            t.prototype.handleTopDragEnter = function(t) {
                var e = this
                  , r = this.dragEnterTargetIds;
                if (this.dragEnterTargetIds = [],
                this.monitor.isDragging()) {
                    d.isFirefox() || this.actions.hover(r, {
                        clientOffset: h.getEventClientOffset(t)
                    });
            ...
            t.prototype.handleTopDragOver = function(t) {
                ...
                !this.monitor.isDragging())
                    ...
                    void (t.dataTransfer.dropEffect = "none");
                ...
                n ? (t.preventDefault(),
                t.dataTransfer.dropEffect = this.getCurrentDropEffect()) : this.isDraggingNativeItem() ? (t.preventDefault(),
                t.dataTransfer.dropEffect = "none") : this.checkIfCurrentDragSourceRectChanged() && (t.preventDefault(),
            ...
            t.prototype.handleTopDropCapture = function(t) {
                this.dropTargetIds = [],
                t.preventDefault(),
                this.isDraggingNativeItem() && this.currentNativeSource.mutateItemByReadingDataTransfer(t.dataTransfer),
            ...
            t.prototype.handleSelectStart = function(t) {
                var e = t.target;
                "function" == typeof e.dragDrop && ("INPUT" === e.tagName || "SELECT" === e.tagName || "TEXTAREA" === e.tagName || e.isContentEditable || (t.preventDefault(),
                e.dragDrop()))
            }
            ,
            t
    ...
    , function(t, e) {
        ...
        var n = function() {
            function t(e, n) {
                r(this, t);
                for (var o = e.length, i = [], a = 0; o > a; a++)
                    i.push(a);
                i.sort(function(t, r) {
                    return e[t] < e[r] ? -1 : 1
                });
                for (var u = [], s = [], c = [], f = void 0, p = void 0, a = 0; o - 1 > a; a++)
                    f = e[a + 1] - e[a],
                    p = n[a + 1] - n[a],
                    s.push(f),
                    u.push(p),
                    c.push(p / f);
                for (var d = [c[0]], a = 0; a < s.length - 1; a++) {
                    var h = c[a]
                      , l = c[a + 1];
                    if (0 >= h * l)
                        d.push(0);
                        ...
                        var v = s[a + 1]
                          , g = f + v;
                        d.push(3 * g / ((g + v) / h + (g + f) / l))
                    }
                }
                d.push(c[c.length - 1]);
                for (var y = [], D = [], m = void 0, a = 0; a < d.length - 1; a++) {
                    m = c[a];
                    var x = d[a]
                      , _ = 1 / s[a]
                      , g = x + d[a + 1] - m - m;
            ...
            return t.prototype.interpolate = function(t) {
                var e = this.xs
                  , r = this.ys
                  , n = this.c1s
                  , o = this.c2s
                ...
                if (t === e[a])
                    return r[a];
                for (var u = 0, s = i.length - 1, c = void 0; s >= u; ) {
                    c = Math.floor(.5 * (u + s));
                    var f = e[c];
                    if (t > f)
                        u = c + 1;
                ...
                var p = t - e[a]
                  , d = p * p;
                return r[a] + n[a] * p + o[a] * d + i[a] * p * d
            }
            ,
            t
        }();
    ...
    , function(t, e, r) {
        ...
        function u(t) {
            ...
            return function() {
                function t() {
                    o(this, t),
                    this.item = Object.defineProperties({}, i({}, r, {
                        get: function() {
                            return console.warn("Browser doesn't allow reading \"" + r + '" until the drop event.'),
                            null
                        },
                        configurable: !0,
                        enumerable: !0
                ...
                return t.prototype.mutateItemByReadingDataTransfer = function(t) {
                    delete this.item[r],
                    this.item[r] = a(t, n)
                }
                ,
        ...
        e.__esModule = !0;
        var c;
        e.createNativeDragSource = u,
        e.matchNativeItemType = s;
        var f = r(7)
          , p = n(f)
          , d = (c = {},
        i(c, p.FILE, {
    ...
    , function(t, e, r) {
        ...
        function o(t) {
            var e = t.nodeType === f ? t : t.parentElement;
            if (!e)
                return null ;
        ...
        function a(t, e, r, n) {
            var i = "IMG" === e.nodeName && (u.isFirefox() || !document.documentElement.contains(e))
              , a = i ? t : e
              , s = o(a)
              , f = {
                x: r.x - s.x,
              ...
              , v = i ? e.width : p
              , g = i ? e.height : d;
            u.isSafari() && i ? (g /= window.devicePixelRatio,
            v /= window.devicePixelRatio) : u.isFirefox() && !i && (g *= window.devicePixelRatio,
            v *= window.devicePixelRatio);
            var y = new c["default"]([0, .5, 1],[f.x, f.x / p * v, f.x + v - p])
              , D = new c["default"]([0, .5, 1],[f.y, f.y / d * g, f.y + g - d])
              , m = y.interpolate(h)
              , x = D.interpolate(l);
            return u.isSafari() && i && (x += (window.devicePixelRatio - 1) * g),
            {
                x: m,
                y: x
            }
        ...
        e.__esModule = !0,
        e.getNodeClientOffset = o,
        e.getEventClientOffset = i,
        e.getDragPreviewOffset = a;
        var u = r(15)
          , s = r(29)
          , c = n(s)
          , f = 1
    ...
    , function(t, e) {
        function r(t, e) {
            for (var r = -1, n = t.length, o = Array(n); ++r < n; )
                o[r] = e(t[r], r, t);
            return o
        }
        t.exports = r
    ...
    , function(t, e, r) {
        function n(t, e, r) {
            var n = t[e];
            (!o(n, r) || o(n, i[e]) && !a.call(t, e) || void 0 === r && !(e in t)) && (t[e] = r)
        }
        var o = r(5)
          , i = Object.prototype
          , a = i.hasOwnProperty;
    ...
    , function(t, e, r) {
        function n(t, e, r, s) {
            ...
            for (var c = -1, f = t.length; ++c < f; ) {
                var p = t[c];
                u(p) && (r || a(p) || i(p)) ? e ? n(p, e, r, s) : o(s, p) : r || (s[s.length] = p)
            }
            return s
        }
        var o = r(38)
    ...
    , function(t, e, r) {
        function n(t) {
            ...
            if (o(t)) {
                var r = e.__data__
                  , n = "string" == typeof t ? r.string : r.hash;
                n[t] = i
            } else
                e.set(t, i)
        }
    ...
    , function(t, e, r) {
        var n = r(36)
          , o = r(80)
          , i = n && 2 === new n([1, 2]).size ? function(t) {
            return new n(t)
        }
        : o;
        t.exports = i
    ...
    , function(t, e, r) {
        function n(t) {
            ...
            return u(e) && (a(t) || s(t) || i(t)) ? o(e, String) : null
        }
        var o = r(50)
          , i = r(24)
          , a = r(10)
    ...
    , function(t, e, r) {
        function n(t, e, r) {
            if (!u(r))
                return !1;
            var n = typeof e;
            return ("number" == n ? i(r) && a(e, r.length) : "string" == n && e in r) ? o(r[e], t) : !1
        }
        var o = r(5)
          , i = r(25)
          , a = r(23)
    ...
    , function(t, e, r) {
        function n(t, e) {
            var r = this.__data__;
            return u(t) ? a("string" == typeof t ? r.string : r.hash, t, e) : o ? r.map.set(t, e) : i(r.map, t, e),
            this
        }
        var o = r(2)
          , i = r(44)
    ...
    , function(t, e, r) {
        function n(t) {
            for (var e = -1, r = u(t), n = o(t), s = n.length, f = i(t), p = !!f, d = f || [], h = d.length; ++e < s; ) {
                var l = n[e];
                p && ("length" == l || a(l, h)) || "constructor" == l && (r || !c.call(t, l)) || d.push(l)
            }
            return d
        }
        var o = r(48)
    ...
    , function(t, e, r) {
        function n(t) {
            ...
            t = t.replace(u, "");
            var r = c.test(t);
            return r || f.test(t) ? p(t.slice(2), r ? 2 : 8) : s.test(t) ? a : +t
        }
        var o = r(12)
          , i = r(13)
          , a = NaN

        ...
        render: function() {
            return (
                <div className={(this.props.className || '')}>
                    <div className="row">
                        <LeftMenu className="col-xs-6 col-md-4 col-lg-3 left-menu toggle-show" topologyModel={this.topologyModelControllerLinkMode}></LeftMenu>
                        ...
                        <RightMenu className="col-xs-6 col-md-8 col-lg-9 right-menu " topologyModel={this.topologyModel} createLink={this.createLink} topologyModelController={this.topologyModelController}></RightMenu>

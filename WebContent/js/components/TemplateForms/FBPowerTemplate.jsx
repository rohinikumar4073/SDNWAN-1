define(['react','jsx!components/BootstrapButton','properties','toastr'], function(React,BootstrapButton,properties,toastr) { var FBPowerData = React.createClass({
...
<div className="form-group">
  ...
  <div className="form-group">
    <label for="status">Status:</label>
    	 <div className="radio">
  <label><input type="radio" name="status" onChange={this.onChangeFunction}></input>raft</label>
</div>
<div className="radio">
...
<div className="radio">
 ...
 <div className="form-group">
   ...
   <div className="radio">
  <label><input type="radio" name="powerType" onChange={this.onChangeFunction}></input>AC</label>
</div>
<div className="radio">
...
<div className="form-group">
   ...
   <div className="form-group">
    <label for="airFlow">Air Flow </label>
	 <div className="radio">
  <label><input type="radio" name="airFlow" onChange={this.onChangeFunction}></input>Front-to-Back</label>
</div>
<div className="radio">

...
<div className="accordion">
	...
	<div className="form-group">
		<label for="manufacturerOS">Manufacturer:</label> <input type="text"
			className="form-control" id="manufacturerOS" onChange={this.onChangeFunction}></input>
	</div>
	<div className="form-group">
		<label for="versionOS">Version:</label> <input type="text"
			className="form-control" id="versionOS" onChange={this.onChangeFunction}></input>
	</div>
	<div className="form-group">
		<label for="imageFileNameOS">Image File Name:</label> <input type="text"
			className="form-control" id="imageFileNameOS" onChange={this.onChangeFunction}></input>
	</div>

	<div className="form-group">
		<label for="orderablePartNumberOS">Orderable Part Number:</label> <input
			type="text" className="form-control" id="orderablePartNumberOS" onChange={this.onChangeFunction}></input>
	</div>

	<div className="form-group">
		<label for="descriptionOS">Description:</label> <input type="text"
			className="form-control" id="descriptionOS" onChange={this.onChangeFunction}></input>
	</div>
	...
	<div className="form-group">
		<label for="openFlowVersionOS">OpenFlow Protocol Version(s)
			Supported:</label>
		<div className="radio">
			<label><input type="radio" name="openFlowVersionOS" onChange={this.onChangeFunction}></input>1.3</label>
		</div>
		<div className="radio">
			<label><input type="radio" name="openFlowVersionOS" onChange={this.onChangeFunction}></input>1.5</label>
		</div>
	</div>
					...
					<form>
						<div className="form-group">
							<label for="enableArp">Enable Local ARP Response
								Processing:</label>
							<div className="radio">
								<label><input type="radio" name="enableArp" onChange={this.onChangeFunction}></input>True</label>
							</div>
							<div className="radio">
								<label><input type="radio" name="enableArp" onChange={this.onChangeFunction}></input>False</label>
							</div>
						...
						<div className="form-group">
							<label for="enableNd">Enable Local IPv6 ND Response
								Processing:</label>
							<div className="radio">
								<label><input type="radio" name="enableNd" onChange={this.onChangeFunction}></input>True</label>
							</div>
							<div className="radio">
								<label><input type="radio" name="enableNd" onChange={this.onChangeFunction}></input>False</label>
							</div>
						</div>
						...
						<div className="form-group">
							<label for="interfaceInterval">Interface and Flow Counter
								...
								id="interfaceInterval" onChange={this.onChangeFunction}></input>
						</div>

						<div className="form-group">
							<label for="alarmHistory">Alarm History:</label>
							<div className="radio">
								<label><input type="radio" name="alarmHistory" onChange={this.onChangeFunction}></input>Enabled</label>
							</div>
							<div className="radio">
								<label><input type="radio" name="alarmHistory" onChange={this.onChangeFunction}></input>Disabled</label>
							</div>
						</div>
						...
						<div className="form-group">
							<label for="alarmLow">Alarm Low Temperature(F Degrees):</label> <input
								type="text" className="form-control" id="alarmLow" onChange={this.onChangeFunction}></input>
						</div>
						<div className="form-group">
							<label for="puppet">Puppet Agent Utilized:</label>
							<div className="radio">
								<label><input type="radio" name="puppet" onChange={this.onChangeFunction}></input>True</label>
							</div>
							<div className="radio">
								<label><input type="radio" name="puppet" onChange={this.onChangeFunction}></input>False</label>
							</div>
						</div>

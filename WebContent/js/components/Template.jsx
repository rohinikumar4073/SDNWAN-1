 define(['react','jquery','jsx!components/TemplateElement','jsx!components/BootstrapLink','jsx!components/Details'], function(React,$,TemplateElement,BootstrapLink,Details) {

                        ...
                        <div>
                            <form>
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="appName"></input>
                                </div>
                                ...
                                <div className="form-group ">
                                    ...
                                    <input type="text" className="form-control" id="asn"></input>
                                </div>
                                <div className="form-group ">
                                    <label for="ipv4Ip">IPv4 Management IP:</label>
                                    <input type="text" className="form-control" id="ipv4Ip"></input>
                                </div>
                                <div className="form-group">

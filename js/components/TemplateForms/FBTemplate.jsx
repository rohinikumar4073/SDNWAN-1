                    ...
                    <div className="modal-body">
                        ...
                        <div className="accordion">
                            ...
                            <div className="form-group">
                                ...
                                <div className="radio">
                                    <label>
                                        <input type="radio" className="form-control" id="airFlow" onChange={this.onChangeFunction}></input>Front-to-Back</label>

                                </div>
                                <div className="radio">
                                    <label>
                                        <input type="radio" className="form-control" id="airFlow" onChange={this.onChangeFunction}></input>Back-to-Front</label>
                            ...
                            <div className="form-group">
                                ...
                                <div className="radio">
                                    <label>
                                        <input type="radio" className="form-control" id="powerSupply" onChange={this.onChangeFunction}></input>A.C.</label>

                                </div>
                                <div className="radio">
                                    <label>
                                        <input type="radio" className="form-control" id="powerSupply" onChange={this.onChangeFunction}></input>D.C.</label>
                                    ...
                                    <div id="collapse2" className="panel-collapse collapse">
                                        <div className="panel-body">
                                            <div className="form-group">
                                                ...
                                                <div className="radio">
                                                    <label>
                                                        <input type="radio" className="form-control" id="type" onChange={this.onChangeFunction}></input>x86</label>

                                                </div>
                                                <div className="radio">
                                                    <label>
                                                        <input type="radio" className="form-control" id="type" onChange={this.onChangeFunction}></input>PowerPC</label>
                            ...
                            <div className="form-group">
                                <label for="flashDiskSize">Flash Disk Size (GB) (if applicable):</label>
                                <input type="text" className="form-control" id="flashDiskSize" onChange={this.onChangeFunction}></input>
                            </div>
                            <div className="form-group">
                                <label for="hardDiskSize">Hard Disk Size (GB) (if applicable):</label>
                            ...
                            <div className="form-group">
                                ...
                                <div className="radio">
                                    <label>
                                        <input type="radio" className="form-control" id="nebsComplaint" onChange={this.onChangeFunction}></input>Yes</label>

                                </div>
                                <div className="radio">
                                    <label>
                                        <input type="radio" className="form-control" id="nebsComplaint" onChange={this.onChangeFunction}></input>No</label>

                                </div>
                            </div>
                            <div className="form-group">
                                <label for="numberOfDataPlaneInterfaces">Number of Data Plane Interfaces:</label>
                                <input type="text" className="form-control" id="numberOfDataPlaneInterfaces" onChange={this.onChangeFunction}></input>
                            </div>
                            <div className="panel-group">
                                <div className="panel panel-default">
                                    <div className="panel-heading">
                                    ...
                                    <div id="collapse4" className="panel-collapse collapse">
                                        <div className="panel-body">
                                            <div className="form-group">
                                                <label for="interfaceType">Interface Type (i.e. SFP&#43; 1/10GbE, QSFP&#43; 40GbE):</label>
                                                <input type="text" className="form-control" id="interfaceType" onChange={this.onChangeFunction}></input>
                                            </div>
                                            <div className="form-group">
                                            ...
                                            <div className="form-group">
                                                <label for="breakoutConnectorDataPlaneInterfaceIdentifier1">Breakout Connector #1 Data Plane Interface Identifier/Label:</label>
                                                <input type="text" className="form-control" id="breakoutConnectorDataPlaneInterfaceIdentifier1" onChange={this.onChangeFunction}></input>
                                            </div>
                                            <div className="form-group">
                                                <label for="breakoutConnectorDataPlaneInterfaceIdentifier2">Breakout Connector #2 Data Plane Interface Identifier/Label:</label>
                                                <input type="text" className="form-control" id="breakoutConnectorDataPlaneInterfaceIdentifier2" onChange={this.onChangeFunction}></input>
                                            </div>
                                            <div className="form-group">
                                                <label for="breakoutConnectorDataPlaneInterfaceIdentifier3">Breakout Connector #3 Data Plane Interface Identifier/Label:</label>
                                                <input type="text" className="form-control" id="breakoutConnectorDataPlaneInterfaceIdentifier3" onChange={this.onChangeFunction}></input>
                                            </div>
                                            <div className="form-group">
                                                <label for="breakoutConnectorDataPlaneInterfaceIdentifier4">Breakout Connector #4 Data Plane Interface Identifier/Label:</label>
                                                <input type="text" className="form-control" id="breakoutConnectorDataPlaneInterfaceIdentifier4" onChange={this.onChangeFunction}></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="collapse6" className="panel-collapse collapse">
                                        <div className="panel-body">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div className="radio">
                                                    <label>
                                                        <input type="radio" className="form-control" id="connectionType" onChange={this.onChangeFunction}></input>RJ45</label>

                                                </div>
                                                <div className="radio">
                                                    <label>
                                                        <input type="radio" className="form-control" id="connectionType" onChange={this.onChangeFunction}></input>USB Mini-Type B
                                                    </label>
                                                </div>
                                            </div>
                                        </div>

define([
    ...
    var VerifiedLayout = React.createClass({
        animate: function() {
        ...
        {
          var boundaries={x:{min:25,max:SCREEN_WIDTH},y:{min:(SCREEN_HEIGHT+190),max:(2*SCREEN_HEIGHT+190)}}
         ...
         this.setState({position:{top:event.clientY-80 ,left:event.clientX-25}})
         	...
         	mouse.x = ( (event.clientX-25) / (SCREEN_WIDTH) ) * 2 - 1;
            ...
            if (intersects.length > 0) {
                ...
                if (intersects[0].object != INTERSECTED) {
                    ...
                    if (intersects[0].object.name) {
                        ...
                        this.props.setParentState({"parentClass":"verifiedlayout-on","heading":message,"data":dataObjectValue,position:this.state.position})
                ...
                this.props.setParentState({"parentClass":"verifiedlayout-off"})
        ...
        initScene: function() {
            ...
            $("#verifiedlayout").height(SCREEN_HEIGHT)
            container = document.getElementById('verifiedlayout');
        ...
        componentDidMount: function() {
            SCREEN_WIDTH = parseInt($("#verifiedlayout").width());

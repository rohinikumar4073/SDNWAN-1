        ...
        render: function() {
            return (
                <div className={(this.props.className || '')}>
                    <div className="row">
                      <LeftMenu  className={ !this.state.multiLayered ? "col-xs-4 col-md-4 col-lg-3 left-menu toggle-show" :"hidden"}  topologyModel={this.topologyModelControllerLinkMode}></LeftMenu>
                    <div className={!this.state.multiLayered ? "toggle-left-menu col-xs-4 col-md-4 col-lg-3":"hidden"}>
                        ...
                        <RightMenu setMultiLayered={this.setMultiLayered} ref="RightMenu" className={this.state.multiLayered ? "col-xs-12 right-menu ":"col-xs-8 col-md-8 col-lg-9 right-menu "} topologyModel={this.topologyModel} createLink={this.createLink} topologyModelController={this.topologyModelController}></RightMenu>

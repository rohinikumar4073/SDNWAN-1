define([
    ...
    'reactFilterFactory',
    'axios',
    'jsx!components/FBConfigurationForms/ToggleFb',
    'stomp'
], function(React,
   $, properties,
    toastr,
    ...
    var InventoryBody = React.createClass({
        getInitialState: function() {
            return {
                ...
                columnDefs: [
                    {
                        headerName: 'OTI Activate',
                        field: "action",
                        width: 150,
                        pinned: true,
                        cellRendererFramework: ToggleFb
                    }, {
                        headerName: 'Name',
                        field: "label",
                        width: 250,
        ...
        componentDidMount: function() {
            ...
            axios.get(properties.getNativeTopologyData).then(function(response) {
                ...
                response.data.nodes.forEach(function(v, i) {
                    ...
                    //self.getOtherData(v.label,v.iconType);
                })

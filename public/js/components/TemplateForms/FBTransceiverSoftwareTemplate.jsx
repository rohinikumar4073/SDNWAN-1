    ...
    var FBTranseiverData = React.createClass({
      onSubmit: function(e) {
        ...
        handleConfirm: function(data) {
            var self = this;
            $.ajax({
                url: properties.templateIp + "createTransceiverSoftware",
                type: 'post',
                data: JSON.stringify(data),
                contentType: "application/json; charset=utf-8",
                success: function(data) {
                    toastr.success("Success! Transeiver Software Template is successfully created")
                },
                error: function(data) {
                    toastr.error("Error! Could not create a Transeiver Software Template")

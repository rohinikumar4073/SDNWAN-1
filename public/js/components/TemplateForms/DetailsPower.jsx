define([
    ...
    const formData = {
        "templateInfo": {
            "templateCategory": "FB Power Template"
        }
    };

    var DetPowerData = React.createClass({
            ...
            return (
                <div className={this.props.className}>
                    ...
                    <div className="modal-body">
                        <DetPowerForm schema={schema} uiSchema={uiSchema} formData={this.props.collection}>
                        <div>

define([
    ...
    var FormBGPServer = Form.default;

    const schema = {
      "title": "BGP Server Instance",
      "type": "object",
      "properties": {
        "host_name": {
          "type": "string",
    ...
    var CreateBGPServer = React.createClass({
      ...
      updateData:function(){
        if(this.props.submitMode != "Save"){
          ...
          var name=this.props.formData["name"]+"_bgp";
            ...
            success: function(nodeData){
              ...
              if(self.props.submitMode !== "Update"){
                check = self.checkDuplicate(dat, hostname);
                  ...
                  if(check){
                    var portData={name: data["host_name"], ports: [], type: "bgp"};
                        ...
                        success: function(datareturn) {
                          if (datareturn == "success") {
                            if(self.props.submitMode == "Update"){
                              ...
                              var logData =
                                  {
                                    "configuration": "Create BGP Server",
                                    "type": "success",
                                    "message": "BGP Server created sucessfully!",
                                    "element": hostname
                                  }
                              $.ajax({
                    ...
                    var hostData={value: data, key: data["host_name"]+"_bgp"}
                    $.ajax({
          ...
          return (
              ...
              <div className={"modal-content " + this.props.className}>
                  ...
                  <div className="modal-body">
                      <FormBGPServer schema={schema} uiSchema={uiSchema} validate={this.validate} formData={this.state.formData} className="formFB" onSubmit={this.onSubmit} onError={errors => {

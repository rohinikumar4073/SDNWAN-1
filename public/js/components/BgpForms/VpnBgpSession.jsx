                        ...
                        <div>
                            <form>
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="vpnName" onChange={this.onChangeFunction}></input>
                                </div>
                                ...
                                <div className="form-group">
                                    <label for="portIpv4" className={this.state.ipv4isEnabled == "true"
                                        ? ""
                                        : "hidden"} onChange={this.onChangeFunction}>Port:</label>
                                    <input type="text"  id="portIpv4" className={this.state.ipv4isEnabled == "true"
                                        ? "form-control"
                                        : "hidden" } onChange={this.onChangeFunction}></input>
                                </div>
                                <div className="form-group">
                                    <label for="ipAddressIpv4" className={this.state.ipv4isEnabled == "true"
                                        ? ""
                                        : "hidden"} onChange={this.onChangeFunction}>IP Address:</label>
